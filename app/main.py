...
async def send_invite(invitation: Inviation):
    html_content = f"""
    <!DOCTYPE html>
    <html>
    <head></head>
    <body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
            ...
            <p>Hello,</p>
            <p>I am excited to invite you all to view our User Management API documentation on ReDoc for the project ID: <strong>{invitation.project_id}</strong>.</p>
            ...
            <p>
                <a href="https://github.com/MOHAN2310/Usermanagement-GCP.git" style="display: inline-block; background-color: #28a745; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-size: 16px;">Visit GitHub Repository</a>
            </p>
